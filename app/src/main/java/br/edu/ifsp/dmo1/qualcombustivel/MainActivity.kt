...
class MainActivity : AppCompatActivity(), OnClickListener {
    ...
    //Faz o calculo do combustivel mais vantajoso para o abastecimento
    //O metodo valida os dados de entrada e apresenta as mensagens diretamente em objetos layoute.
    ...
    //Recupera o valor Double do Edittext
    //Em caso de ERRO (Exceção) o valor 0 (Zero) é retornado.
